...
from ImagePreProcessor import ImagePreProcessor, Thresholder, GlobalThresholder, GlobalOptimizedThresholder, AdaptiveThresholder
...
def main():
    ...
    table_extractor_1 = TableExtractor2(
        image=image,
    ...
    table_extractor_2 = TableExtractor2(
        image=image,
        background_color=(163, 151, 152),
